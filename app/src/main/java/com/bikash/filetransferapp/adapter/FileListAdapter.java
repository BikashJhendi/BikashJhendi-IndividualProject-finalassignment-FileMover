package com.bikash.filetransferapp.adapter;
...
import com.bikash.filetransferapp.base.GlideApp;
...
import com.bikash.filetransferapp.util.MimeIconUtils;
        ...
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<FileListAdapter.GenericFileHolder>
{
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.drawable.ic_logo));
