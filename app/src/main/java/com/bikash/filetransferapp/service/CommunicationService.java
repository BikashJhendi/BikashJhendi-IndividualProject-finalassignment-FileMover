...
import com.bikash.filetransferapp.base.AppConfig;
import com.bikash.filetransferapp.base.Keyword;
import com.bikash.filetransferapp.db.AccessDatabase;
import com.bikash.filetransferapp.fragment.FileListFragment;
import com.bikash.filetransferapp.util.AppUtils;
import com.bikash.filetransferapp.util.CommunicationBridge;
import com.bikash.filetransferapp.util.CommunicationNotificationHelper;
import com.bikash.filetransferapp.util.DynamicNotification;
import com.bikash.filetransferapp.util.FileUtils;
import com.bikash.filetransferapp.util.HotspotUtils;
import com.bikash.filetransferapp.util.NetworkDeviceLoader;
import com.bikash.filetransferapp.util.NetworkUtils;
import com.bikash.filetransferapp.util.NotificationUtils;
import com.bikash.filetransferapp.util.NsdDiscovery;
import com.bikash.filetransferapp.util.TimeUtils;
import com.bikash.filetransferapp.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.bikash.filetransferapp.R;
import com.bikash.filetransferapp.model.NetworkDevice;
import com.bikash.filetransferapp.model.TextStreamObject;
import com.bikash.filetransferapp.model.TransferGroup;
import com.bikash.filetransferapp.model.TransferInstance;
import com.bikash.filetransferapp.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.bikash.filetransferapp.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.bikash.filetransferapp.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.bikash.filetransferapp.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.bikash.filetransferapp.action.IP";
    public static final String ACTION_END_SESSION = "com.bikash.filetransferapp.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.bikash.filetransferapp.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.bikash.filetransferapp.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.bikash.filetransferapp.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.bikash.filetransferapp.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.bikash.filetransferapp.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.bikash.filetransferapp.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.bikash.filetransferapp.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.bikash.filetransferapp.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.bikash.filetransferapp.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.bikash.filetransferapp.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.bikash.filetransferapp.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.bikash.filetransferapp.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.bikash.filetransferapp.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.bikash.filetransferapp.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.bikash.filetransferapp.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.bikash.filetransferapp.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.bikash.filetransferapp.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.bikash.filetransferapp.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.bikash.filetransferapp.transaction.action.REQUEST_WEBSHARE_STATUS";
